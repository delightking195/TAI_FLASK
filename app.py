...
def signup():
    ...
    # creating a cursor that will help us to execute querries with
    cursor=connection.cursor()
    # sql query
    # %s is a placeholder that will be replaced when actual data arrives its for security reasons
...
def add_product():
    ...
    return jsonify({"message":"product details added succesfully"})
